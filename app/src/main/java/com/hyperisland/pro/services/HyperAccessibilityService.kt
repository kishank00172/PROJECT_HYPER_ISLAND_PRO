...
class HyperAccessibilityService : AccessibilityService() {
    ...
    private fun openCurrentNotification() {
        ...
        setExpandedAnimated(IslandStage.STAGE1_IDLE, ExpandReason.AUTO_NOTIFICATION)
    }
    ...
    private fun setStageAnimated(targetStage: IslandStage, reason: ExpandReason) {
        setExpandedAnimated(targetStage, reason)
    }

    private fun setExpandedAnimated(targetStage: IslandStage, reason: ExpandReason) {
